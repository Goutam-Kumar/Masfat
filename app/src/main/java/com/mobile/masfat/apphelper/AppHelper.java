package com.mobile.masfat.apphelper;
...
public class AppHelper {
    ...
    public static AlertDialog blurBehindAlertDlg(Activity context,AlertDialog.Builder builder){
        AlertDialog alert=builder.create();
        Bitmap map=AppHelper.takeScreenShot(context);
